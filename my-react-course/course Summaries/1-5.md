...
7.) To use with scss - should: </b> a.) run npm install node-sass </b> b.) change test: /\.css$/, to  test: /\.scss$/,</b> c.) rename the folder from css to scss and file to *.scss </b> d.) import '../scss/style.scss';
